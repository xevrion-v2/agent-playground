...
> 墨子 Harness · issue #4786

---

## ✅ 已完成

- 阅读 issue #4786，确认任务是新增 dependency-free API utility。
- 新增 `apps/api/src/utils/is-open-bracket-symbol-present.ts`。
- 手动验证函数返回值：包含 `[` 返回 true；无 `[` 返回 false。
